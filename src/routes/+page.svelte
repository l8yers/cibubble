<script>
	...
	onMount(async () => {
		loading = true;
		// Get videos, add more fields as needed
...
<div class="page-container">
	...
	{:else if videos.length === 0}
		<div style="margin-top:2em;text-align:center;color:#888;font-size:1.1em;">
...
<style>
	.page-container {
		max-width: 1920px; /* or 1200px, or whatever width you prefer */
		margin: 0 auto;
		padding: 2rem 2vw 2.5rem 2vw; /* Gives space left/right and on top/bottom */
