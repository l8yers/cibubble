...
<!-- ADMIN PANEL ACCESS CONTROL + PANEL -->
<div>
  <h2>Admin Panel Access Test</h2>
  <div>
...
<style>
  /* ... all your admin panel styles, same as before ... */
  .center-content {
    display: flex;
